        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorTimings_Doctors_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "FullName", "IsAdmin", "NationalCode", "Password", "PhoneNumber", "RegisterDate", "UserName" },
                values: new object[] { 1, "ادمین سایت", true, null, "$2a$11$L7BwWAEYOscnFnrFlP0eluWfe3MJbekiP2zH0.zRVlutHcYEZs5hK", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorTimings_DoctorId",
                table: "DoctorTimings",
                column: "DoctorId");
